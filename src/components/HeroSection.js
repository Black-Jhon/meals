...
const HeroSection = () => {
  return (
    <motion.div className="md:px-40 px-5 md:bg-inherit bg-[#da3743] md:flex justify-between items-center py-5" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
